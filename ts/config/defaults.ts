...
export const promptDefaults: PromptTemplates = {
   ...
   vote: '[Anonymous vote — your ballot is secret; no one sees who voted for what, only the totals. Reply with ONLY the number of your choice from the menu below (0 to abstain). Do not explain.]\n\n',
